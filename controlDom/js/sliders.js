...
let inyOut = document.querySelector('.inyOut');
...
color.addEventListener('input', function () {
    ...
    preview.style.boxShadow = sliderX.value + 'px ' + sliderY.value + 'px px ' + color.value;
...
inyOut.addEventListener('click', function(){
